	...
	if (td.category === "curr") {
		...
		if (
			...
			if (global.theme === "dark") {
				return "dc-table-selected-td-dark start end";
			} else {
				return "dc-table-selected-td-light start end";
			}
		}

		if (sortSelectedDateList[0] === td.timestamp) {
			if (global.theme === "dark") {
				return "dc-table-selected-td-dark start";
			} else {
				return "dc-table-selected-td-light start";
			}
		}
		if (sortSelectedDateList[1] === td.timestamp) {
			if (global.theme === "dark") {
				return "dc-table-selected-td-dark end";
			} else {
				return "dc-table-selected-td-light end";
			}
		}
		...
		if (
			...
			if (global.theme === "dark") {
				return "dc-table-selected-td-dark";
			} else {
				return "dc-table-selected-td-light";
			}
		}
	}
	return "";
...
const dynamicSelection = (td: IDate) => {
	if (attrs.disabledDate && !optional(td.timestamp)) return;
	if (
		props.selectedDateList.length === 2 &&
