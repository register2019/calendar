...
const openCalendar = () => {
	...
	if (startDateTime.value && endDateTime.value) {
		...
		if (
			startDateTime.value &&
			endDateTime.value &&
			(panelStartDate.value === "" || panelEndDate.value === "")
		) {
			panelStartDate.value = dateFormat(dateToTimeStamp(startDateTime.value));
			panelEndDate.value = dateFormat(dateToTimeStamp(endDateTime.value));
		}
